...
public class TestsResource {
    ...
    public ResponseEntity<TestsDTO> updateTests(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, testsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TestsDTO> partialUpdateTests(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, testsDTO.getId().toString())
        );
    }
