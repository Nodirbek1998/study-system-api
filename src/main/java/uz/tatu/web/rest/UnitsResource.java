...
public class UnitsResource {
    ...
    public ResponseEntity<UnitsDTO> updateUnits(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, unitsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<UnitsDTO> partialUpdateUnits(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, unitsDTO.getId().toString())
        );
    }
