...
public class StudyLogsResource {
    ...
    public ResponseEntity<StudyLogsDTO> updateStudyLogs(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, studyLogsDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<StudyLogsDTO> partialUpdateStudyLogs(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, studyLogsDTO.getId().toString())
        );
    }
